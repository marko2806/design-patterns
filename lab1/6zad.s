...
.LFB1:
	...
	//Postavljanje virtualne tablice - prvo se iniciajalizira ova tablica,
	//a onda tablica u razredu Derived
	lea	rdx, _ZTV4Base[rip+16]
	mov	rax, QWORD PTR -8[rbp]
	mov	QWORD PTR [rax], rdx
	mov	rax, QWORD PTR -8[rbp]
	mov	rdi, rax
	//poziva se Base::metoda()
...
.LFB4:
	...
	mov	rdi, rdx
	//Dinamicki poziv iz tablice virtualnih funkcija
	call	rax
	nop
	leave
	.cfi_def_cfa 7, 8
...
.LFB6:
	...
	mov	rax, QWORD PTR -8[rbp]
	mov	rdi, rax
	//poziv Base:Base() konstruktora
	call	_ZN4BaseC2Ev
	//postavljanje virtualne tablice
...
.LEHE1:
	...
	mov	rdi, rax
.LEHB2:
	//treci redak u main() funckiji. "Rucni" poziv metode metoda()
	call	_ZN4Base6metodaEv
	mov	eax, 0
	jmp	.L10
.L9:
